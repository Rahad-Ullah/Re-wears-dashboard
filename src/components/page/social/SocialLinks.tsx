...
export default function SocialLinks({ socialData }) {
    ...
    <div className="bg-white h-full rounded-2xl p-5">
      <div className="flex items-center justify-center h-full">
        <div className="max-w-md w-full">
          <h1 className="text-center text-3xl font-bold text-gray-500 mb-6">
            Social Link
          </h1>
          <form onSubmit={handleSubmit}>
            <div className="my-2">
              ...
              <Input
                ...
                defaultValue={socialData?.tikTokUrl}
              />
            </div>
            <div className="my-2">
              ...
              <Input
                ...
                defaultValue={socialData?.facebookUrl}
              />
            </div>
            <div className="my-2">
              ...
              <Input
                ...
                defaultValue={socialData?.instagramUrl}
              />
            </div>
            <div className="my-2">
              <Label>Email</Label>
              <Input
                name="email"
                placeholder="Enter your email link"
