...
const Selling = () => {
  ...
  const { content, setContent } = useGetSettingData("/cms/selling");
  ...
  const handleUpdate = async () => {
    ...
    try {
      toast.loading("Processing", { id: "selling-data-get" });
      ...
      toast.error("Something went wrong.", { id: "selling-data-get" });
    }
  };
