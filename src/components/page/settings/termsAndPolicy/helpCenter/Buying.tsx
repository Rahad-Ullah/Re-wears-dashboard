...
const Buying = () => {
  ...
  const { content, setContent } = useGetSettingData("/cms/buying");
  ...
  const handleUpdate = async () => {
    ...
    try {
      toast.loading("Processing", { id: "buying-data" });
      ...
      toast.error("Something went wrong.", { id: "buying-data" });
    }
  };
